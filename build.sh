...
mkisofs -o FreeDOS.iso -b isolinux/isolinux.bin -input-charset utf8 -no-emul-boot -boot-load-size 4 -boot-info-table -N -J -r -c boot.catalog -hide boot.catalog -hide-joliet boot.catalog ${TOPDIR}/CDROOT
